<template>
	<div class="index">
		...
		<div class="bottomNav">
			<div class="navItem" @click="$router.push('dishes_home')" :class="{index : $store.state.routePage == '/dishes_home'}">
				<div class="logo home"></div>
				<div>首页</div>
			</div>
			<div class="navItem" @click="$router.push('census')" :class="{index : $store.state.routePage == '/census'}">
				<div class="logo xinx"></div>
				<div>统计</div>
			</div>
			<div class="navItem" @click="$router.push('dishes_memder')" :class="{index : $store.state.routePage == '/dishes_memder'}">
